...
## Feature 3: Search Bar for Independent Country Data

* Person responsible: Milly
* User story: As a user, I want to search up each country to independently understand how each country is being affected by deforestation and how the effects of deforestation play a role in carbon emissions without the clutter of a map or scatterplot.
* Acceptance Criteria:
  - Throw out information about the changes in their forests.
  - Throw out information about the changes in their CO2.
  - Show their tree land coverage.
  - Country ranking.
...
https://ourworldindata.org/grapher/forest-share.csv
